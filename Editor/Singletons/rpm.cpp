...
void RPM::readTranslations() {
    ...
    RPM::ENUM_TO_STRING_EVENT_COMMAND_KIND = QStringList({
        ...
        RPM::translate(Translations::DISPLAY_HIDE_A_BATTLER) + RPM::DOT_DOT_DOT,
        RPM::translate(Translations::TRANSFORME_A_BATTLER) + RPM::DOT_DOT_DOT,
        RPM::translate(Translations::CHANGE_BATTLER_GRAPHICS) + RPM::DOT_DOT_DOT,
        ""
    });
